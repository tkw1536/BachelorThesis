...
Sometimes it is useful not to write down a theorem explicitly, but only give an existing theorm and translate this along a view or import. The MMT URL of this induced theorem can then be given using the view\ednote{Example URI here}\cite{IanKohProd:rassmk14}.
...
\subsection{Using theory graphs for Quantity Expressions}
