...
\ednote{Subsections?} \ednote{Is the section title correct?}

\ednote{Describe the WPs one by one here}
...
\ednote{Next section continues here}
...
\ednote{Write a final paragraph to wrap it up. }
