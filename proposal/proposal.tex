...
As mentioned above, MathWebSearch is a search engine for mathmatical formulars in documents. It has a corpus of ??? documents \ednote{Get an estimate here} and is currently deployed and used by Zentralblatt Math \ednote{link to their front-end here; mayber mention a bit more about it}.
