...
In the example above \ednote{Check if example is correct}, we first define the a symbol $G$ (the set of the Semigoup), as well as a (binary) operation $\circ$ and then the law of associativity for the operation $\circ$.
...
\label{sec:timings}
\ednote{Think of a better section title?}
