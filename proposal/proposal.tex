...
\begin{itemize}
  ...
  \item has a corpus of ??? \ednote{Get an estimate here} documents
  \item currently used by ??? and ??? \ednote{where? }
\end{itemize}
...
The backend
\begin{itemize}
  \item written in \ednote{find out}
  \item has a big search index
  \item searches the index only
\end{itemize}

\ednote{Explain theory graphs here}
