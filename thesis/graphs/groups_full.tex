...
\begin{figure}[h]
  ...
  \caption{A Simple Theory Graph. \footnote{Imports are represented as solid edges and views as wavey edges. The mappings of the views are given explicitly. We omit the complete definitions of the Peano axiomes for the natural numbers. }}
